...
The generated command is `npx --yes --package=@deepseek-ai/dsh@0.1.0-rc.7 -- dsh --profile codex`. The helper never uses `npx.cmd` or `shell: true`, and it never imports `StdioServerTransport`.
...
| `dshPackage` | `@deepseek-ai/dsh@0.1.0-rc.7` | Pinned package in generated npx args |
