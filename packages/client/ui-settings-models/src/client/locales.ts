...
export const en = {
  ...
  credentialScope: 'API key scope',
  credentialScopeGlobal: 'Global default (all Codex projects)',
  credentialScopeProject: 'This project only',
  credentialScopeHint: 'Project keys override the global default. Saving globally removes this project’s override.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  credentialScope: 'API 密钥作用域',
  credentialScopeGlobal: '全局默认（所有 Codex 项目）',
  credentialScopeProject: '仅当前项目',
  credentialScopeHint: '项目密钥优先于全局默认；保存为全局时会移除当前项目的覆盖。',
