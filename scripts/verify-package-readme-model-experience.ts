...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/codex': { kind: 'indirect', reason: 'The bundle mounts dsh-mcp-codex, which submits ordinary Host session messages; the composed Web agent owns prompts and tools.' },
  'packages/mcp/mcp-codex': { kind: 'indirect', reason: 'The MCP tools submit ordinary Host session messages; the composed Web agent owns prompts and tools.' },
